...
def extract_reasoning_output(text: str) -> tuple[str | None, str | None]:
...
def extract_instruction_output(text: str) -> str | None:
...
def generate_synthetic_data(
    ...
    task_type: str,
    num_samples: int,
    categories: dict[int, list[int]] | None = None,
) -> list[dict]:
...
def main():
    ...
    logger.info(
        "Done! Dataset available at: https://huggingface.co/datasets/" + args.output_dataset
    )
