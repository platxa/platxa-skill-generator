...
metadata:
  version: "1.0.0"
  tags: [prompting, best-practices, claude-code, workflow]
---
...
- [references/best-practices-guide.md](references/best-practices-guide.md) — Core principles, patterns, failures
- [references/prompt-patterns.md](references/prompt-patterns.md) — Templates, anti-patterns, task prompts
