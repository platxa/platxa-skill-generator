#!/usr/bin/env python3
"""atlas_common.py - Shared utilities for Atlas CLI.

Provides:
    - Atlas app detection and AppleScript execution
    - Chromium profile path resolution
    - SQLite database copy for safe reads
    - Error types and permission hint detection
"""
